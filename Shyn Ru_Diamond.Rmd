...
We have data about `r nrow(diamonds)` diamonds. Only `r nrow(diamonds) - nrow(small)` are larger than 2.2 carats. The distribution of the remainder is shown below:
